    ...
    <div class="navbar-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" key="t-contact">@lang('translation.contact')</a>
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="contact-profile"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">@lang('translation.Profile')</span></a>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-contact"
                                    role="button" >
                                    <span key="t-contact">@lang('translation.contact')</span> <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    <a href="contact-grid" class="dropdown-item" key="t-user-grid">@lang('translation.User_Grid')</a>
                                    <a href="contact-list" class="dropdown-item" key="t-user-list">@lang('translation.User_List')</a>
                                    <a href="contact-profile" class="dropdown-item" key="t-profile">@lang('translation.Profile')</a>
                                </div>
                            </div>

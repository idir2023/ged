...
<li>
  <a href="javascript: void(0);" class="has-arrow waves-effect">
    ...
    <span key="t-contact">@lang('translation.contact')</span>
  </a>
  <ul class="sub-menu" aria-expanded="false">
    <li><a href="contact-grid" key="t-user-grid">@lang('translation.User_Grid')</a></li>
    <li><a href="contact-list" key="t-user-list">@lang('translation.User_List')</a></li>
    <li><a href="contact-profile" key="t-profile">@lang('translation.Profile')</a></li>
  </ul>
</li>

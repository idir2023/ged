            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-4" id="action_btns">
                        <a href="{{ route('chefdep.create') }}" class="btn btn-rounded btn-success waves-effect waves-light ms-2">
        ...
        $(function() {
            let table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    {
    data: 'mot_de_passe_chef_projet',
    render: function(data) {
        return data; // Affiche le mot de passe directement
    }
},

...
class ChefDeDepartementController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
                ...
                $data = ChefDeDepartement::with('departement')->select(['id_chef', 'nom_chef', 'prenom_chef', 'email_chef', 'telephone_chef', 'id_dep', 'mot_de_passe_chef_projet']);
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $editUrl = route('chefdep.edit', $row->id_chef);
                    $deleteUrl = route('chefdep.destroy', $row->id_chef);
                    return '
    ...
    public function store(Request $request)
    {
        ...
        ChefDeDepartement::create([
            ...
            'mot_de_passe_chef_projet' => $request->mot_de_passe_chef_projet, // En clair
    ...
    public function edit($id_chef)
    {
        ...
        $departements = Departement::all();
        return view('admin.chefdep.edit', compact('chef', 'departements'));
    }
    ...
    public function update(Request $request, $id_chef)
    {
        ...
        $chef->update([
            ...
            'telephone_chef' => $request->telephone_chef,
            $chef->update([
                'mot_de_passe_chef_projet' => $request->mot_de_passe_chef_projet ? $request->mot_de_passe_chef_projet : $chef->mot_de_passe_chef_projet,
        ...
        return redirect()->route('chefdep.index')->with('success', 'Chef de département mis à jour avec succès.');
    }
    ...
    public function destroy($id_chef)
    {
        ...
        return redirect()->route('chefdep.index')->with('success', 'Chef de département supprimé avec succès.');
    }
}
